...
const DashboardVoterPresidentConf = () => {
  const {Vote,loading} = useContext(Store)
  ...
  return (
    <div className="dashboard-voter-president-conf">
      ...
      <div className="cancel-group">
        ...
        <button className="select1" onClick={()=>Vote(info[0],info[3])} data-animate-on-scroll disabled={loading}>
...
export default DashboardVoterPresidentConf;
